...
export { default as CsCard } from '../../components/CsCard.vue'
...
export const LazyCsCard = import('../../components/CsCard.vue' /* webpackChunkName: "components/CsCard" */).then(c => c.default || c)
